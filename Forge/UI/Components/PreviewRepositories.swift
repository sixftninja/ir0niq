...
final class PreviewSessionRepository: SessionRepositoryProtocol, @unchecked Sendable {
    ...
    func updateSet(setId: UUID, status: SetStatus, reps: Int?, weight: Double?, setTimerStart: Date?, setTimerEnd: Date?, restStart: Date?, restEnd: Date?, isUnrecorded: Bool) async throws {}
...
final class PreviewExerciseRepository: ExerciseRepositoryProtocol, @unchecked Sendable {
    ...
    func insert(id: UUID, name: String, exerciseDescription: String, equipmentType: EquipmentType, isSingleHand: Bool, muscleGroups: [MuscleGroup], iconName: String, isCustom: Bool, isSeeded: Bool) async throws -> UUID { UUID() }
    func delete(id: UUID) async throws {}
