...
struct NextSetIntent: AppIntent {
    ...
    static let description = IntentDescription("Advance to the next set in your Forge workout.")
    static let openAppWhenRun = false

    func perform() async throws -> some IntentResult & ProvidesDialog {
        guard let engine = SessionEngine.current else {
            return .result(dialog: "No active Forge session.")
        }
        do {
...
struct PreviousSetIntent: AppIntent {
    ...
    static let description = IntentDescription("Navigate to the previous set in your Forge workout.")
    static let openAppWhenRun = false
...
struct SkipSetIntent: AppIntent {
    ...
    static let description = IntentDescription("Skip the current set in your Forge workout.")
    static let openAppWhenRun = false
    ...
    func perform() async throws -> some IntentResult & ProvidesDialog {
        ...
        do {
            ...
            return .result(dialog: "Exercise skipped.")
        } catch {
...
struct PauseSessionIntent: AppIntent {
    ...
    static let description = IntentDescription("Pause your active Forge workout session.")
    static let openAppWhenRun = false
...
struct ResumeSessionIntent: AppIntent {
    ...
    static let description = IntentDescription("Resume your paused Forge workout session.")
    static let openAppWhenRun = false
...
struct EndSessionIntent: AppIntent {
    ...
    static let description = IntentDescription("End and save your current Forge workout session.")
    static let openAppWhenRun = false
